...
export const WORKOUT_TEMPLATES: WorkoutTemplate[] = [
    ...
    exercises: [
      {
        ...
        muscleGroup: 'Back',
        sets: [
          { setNumber: 1, targetReps: '8',  prevWeight: 'BW (8)' },
          { setNumber: 2, targetReps: '12', prevWeight: 'BW (7)' },
        ],
      },
      {
        exerciseId: 40,
        ...
        muscleGroup: 'Chest',
        sets: [
          { setNumber: 1, targetReps: '8', prevWeight: '225 / 90s' },
          { setNumber: 2, targetReps: '8', prevWeight: '245 / 90s' },
        ],
      },
      {
        exerciseId: 41,
      ...
      },
      {
        ...
        name: 'Lateral Raises',
        muscleGroup: 'Shoulders',
        exerciseNotes: 'Heavy — machine 90 lbs',
        sets: [
          { setNumber: 1, targetReps: '8',   prevWeight: '90', notes: 'Heavyyy' },
          { setNumber: 2, targetReps: '8',   prevWeight: '90', notes: 'Heavyyy' },
          { setNumber: 3, targetReps: '8',   prevWeight: '90', notes: 'Heavyyy' },
      ...
      },
      {
        ...
        sets: [
          { setNumber: 1, targetReps: 'F', prevWeight: 'BW' },
          { setNumber: 2, targetReps: 'F', prevWeight: 'BW (-2 assisted)' },
        ],
      },
    ],
  },
  ...
  // ─── SHOULDER STRENGTHENING (page 10) — optional flex day ──────────────────
  {
    ...
    exercises: [
      {
        ...
        exerciseNotes: 'Hang from pull-up bar — relax traps/scapula, breathe. 2 min total, doesn\'t need to be consecutive',
        sets: [
          { setNumber: 1, targetReps: '1 min', prevWeight: 'BW' },
        ],
      },
      {
        exerciseId: 43,
        ...
        exerciseNotes: 'Drive hands out — squeeze mid traps — slow on negative',
        sets: [
          { setNumber: 1, targetReps: '15', prevWeight: 'Band' },
          { setNumber: 2, targetReps: '15', prevWeight: 'Band' },
          { setNumber: 3, targetReps: '15', prevWeight: 'Band' },
        ],
      },
      {
        exerciseId: 44,
        ...
        exerciseNotes: 'Elbow in hip — rotate hand outwards, keep wrist and elbow joints in line',
        sets: [
          { setNumber: 1, targetReps: '15', prevWeight: 'Band' },
          { setNumber: 2, targetReps: '15', prevWeight: 'Band' },
          { setNumber: 3, targetReps: '15', prevWeight: 'Band' },
      ...
      {
        exerciseId: 45,
        name: '90° to 45° Shoulder Flexion',
        muscleGroup: 'Shoulders',
        exerciseNotes: 'Arm at 90° — rotate hands parallel to floor, then back up',
        sets: [
          { setNumber: 1, targetReps: '15', prevWeight: 'BW' },
          { setNumber: 2, targetReps: '15', prevWeight: 'BW' },
          { setNumber: 3, targetReps: '15', prevWeight: 'BW' },
        ],
      },
      {
        exerciseId: 46,
        name: 'Rear Delt Band Drive',
        muscleGroup: 'Rear Delts',
        exerciseNotes: 'Band above shoulder height — drive hand out, elbow slightly turned up',
        sets: [
          { setNumber: 1, targetReps: '15', prevWeight: 'Band' },
          { setNumber: 2, targetReps: '15', prevWeight: 'Band' },
          { setNumber: 3, targetReps: '15', prevWeight: 'Band' },
      ...
      },
      {
        ...
        name: 'Shrugs',
        muscleGroup: 'Traps',
        exerciseNotes: 'Drive traps to ears — straight path, no rotation',
        sets: [
          { setNumber: 1, targetReps: '15', prevWeight: 'BW' },
          { setNumber: 2, targetReps: '15', prevWeight: 'BW' },
          { setNumber: 3, targetReps: '15', prevWeight: 'BW' },
      ...
      {
        exerciseId: 48,
        name: 'Scapula Pulldowns',
        muscleGroup: 'Upper Back',
        exerciseNotes: 'Retract scapula to pull down flat bar',
        sets: [
          { setNumber: 1, targetReps: '12', prevWeight: 'BW' },
          { setNumber: 2, targetReps: '12', prevWeight: 'BW' },
          { setNumber: 3, targetReps: '12', prevWeight: 'BW' },
        ],
      },
      {
        exerciseId: 49,
